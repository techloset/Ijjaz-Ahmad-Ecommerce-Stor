      ...
      <div className="px-[15px] w-[100%] md:px-[50px] lg:px-[60px] xl:px-[70px]">
        <header className="header py-4">
          <div className="flex items-center justify-between">
            <div className='flex items-center justify-between'>
              <div className="logo">
                <img src={logo} className='w-[100px] h-[28px] md:max-w-[140px] md:h-[39px]' alt="logo" />
              </div>
              <div className="hidden md-2:block">
                <form className="flex items-center search ms-8">
                  <div>
                    <input type='text' className="outline-none rounded-[20px] relative w-[315px] py-3 px-5 text-gray-900 placeholder:text-gray-400" placeholder='Search any things' />
                  </div>
                  <div>
            ...
            <div className='flex'>
              ...
              <span className='flex text-white items-center font-sans mx-[29px]'>
                <div className='flex'>
              ...
              <Link to='/cart' className='flex text-white items-center font-sans'>
                <div className='flex'>
