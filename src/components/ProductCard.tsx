...
export default function Card() {
  // { Name : string, img, Price, id, product }
      ...
      <div className="card mb-4">
        <div className="border-2 border-gray-300 rounded-3xl p-3 px-5 min-w-[100%]  sm:min-w-[280px]  md:min-w-[300px] lg:min-w-[330px] relative cardmain sm:mx-2">
          <div className="image">
            ...
            <img src={logo} alt="Product" className='h-[200px] w-[200px] mx-auto' />
          </div>
          <div className="content">
            <h3 className='mb-3 text-xl font-semibold text-primary'>Hello Product Name...</h3>
            <p className='text-l font-semibold text-primary'>$3344</p>
          ...
          <div className="overlay text-white">
            <div className="grid grid-cols-3 gap-4">
              ...
              <Link to={`/singleproduct/1`} className="overlay-bg flex items-center justify-center text-xl p-2 text-center rounded-2xl">
